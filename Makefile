...
srcdir = .
topdir = /usr/local/ruby/include/ruby-1.9.1
hdrdir = /usr/local/ruby/include/ruby-1.9.1
arch_hdrdir = /usr/local/ruby/include/ruby-1.9.1/$(arch)
VPATH = $(srcdir):$(arch_hdrdir)/ruby:$(hdrdir)/ruby
prefix = $(DESTDIR)/usr/local/ruby
...
pre-install-rb-default:
	$(ECHO) installing default tmpfile libraries
$(RUBYARCHDIR):
	$(Q) $(MAKEDIRS) $@
